...
@media yahoo{
table {table-layout:fixed;float: none !important;height:auto; }
...
.img600x260 { width: 600px !important; height: 260px !important;}
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" background="" bgcolor="#f5f7f8" style="font-family:Arial, sans-serif; font-size:0px;margin:0;padding:0; background: #f5f7f8 !important;">
<!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]-->
  <table align="center" border="0" cellpadding="0" cellspacing="0" background=""  bgcolor="#f5f7f8" style="background: #f5f7f8 !important;" height="100%" width="100%" id="backgroundTable">
    <tr>
        <td class="wrap" align="center" valign="top" width="100%">
          <center>
<!-- content -->
<div style="padding: 0px;"><table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#edeef1">
...
<tr><td valign="top" style="padding-top: 50px; padding-right: 0px; padding-bottom: 5px; padding-left: 0px;"><table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#FFFFFF" style="border: 0px none; background-color: #FFFFFF;">
<tr><td valign="top" style="padding: 0px;"><table cellpadding="0" cellspacing="0" width="100%">
<tr><td style="padding: 0px;"><table cellpadding="0" cellspacing="0" width="100%">
<tr><td align="center" style="padding: 0px;"><table cellpadding="0" cellspacing="0" border="0" align="center" class="full-width">
<tr><td valign="top" align="center" style="padding: 0px;"><table cellpadding="0" cellspacing="0" border="0" width="600"  class="full-width" style="border: 0px none; height: auto;">
</table>
</td>
</tr>
</table>
...
<tr><td valign="top" style="padding: 0px;"><table cellpadding="0" cellspacing="0" border="0" width="100%" style="border: 0px none;">
<tr><td valign="top" style="padding: 40px;"><table cellpadding="0" cellspacing="0" width="100%">
...
<tr><td valign="top"><div style="text-align: left; font-family: arial; font-size: 15px; color: #222222; line-height: 22px; mso-line-height: exactly; vertical-align: middle;">
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr><td valign="top" style="padding-top: 0px; padding-right: 0px; padding-bottom: 50px; padding-left: 0px;"><table cellpadding="0" cellspacing="0" border="0" width="100%" style="border: 0px none;">
